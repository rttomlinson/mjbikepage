...
var source = "{{#each boxCoords}}<div data-slideNum={{slideNum}} style='left:{{left}}%; top:{{top}}%' class='slider-button'><img src='assets/info-btn.png' alt='button for slider' aria-label='button to move slider position'/></div>{{/each}}";
